...
dataset_to_template = {
    ...
    'downstream_vggsound': vggsound_template,
    'downstream_speechcommand': speech_commands_template,
    'downstream_epicsound': epic_sounds_template,
    'downstream_nsynth': nsynth_template,
