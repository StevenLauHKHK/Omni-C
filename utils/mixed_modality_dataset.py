...
class MixedModalityDataset(Dataset):
    ...
    def __init__(self, root_dir, json_file, class_map_json, cfg, mode,
        image_transform=None,
        padding_mode='mirror', audio_augmentation=True,
        vocab_file=None, token_meta_json_file=None, token_pairs_json_file=None,
        text_seq_len=128, augment=False, p_mask=0.15, p_delete=0.1, mask_token_id=103, 
        pad_token_id=0, enable_nsp=False, text_contrastive_mode='simcse',
        return_double_augmentations=False, clip_align=False):
