...
CUDA_VISIBLE_DEVICES=2 python -m torch.distributed.launch \
        ...
        --resume-fine-tune-checkpoint fine_tune_checkpoints/checkpoint_pretrained_Omni-C_image_audio_text_sbora_rank128_alpha128_image_fine_tune_Cars_bs128_ddp/checkpoint-best.pth \
